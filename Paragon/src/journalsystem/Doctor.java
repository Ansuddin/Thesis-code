...
public class Doctor implements Employee
{
  ...
  public void receive(PatientJournalD journal, java.util.Scanner scanner, Hospital hospital)
  {
    ...
    java.lang.String ssnprint = Policy.<java.lang.String>declassifyLow(journal.getSsn());
    java.lang.System.out.println(ssnprint);
    for (int i = 0 ; i < patients.length ; i++)
    {
      if (patients[i].equals(ssnprint))
      {
        ...
        java.lang.System.out.println("lock should open");
      }
    }
